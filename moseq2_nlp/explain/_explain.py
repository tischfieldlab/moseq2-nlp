...
class Explainer(object):
    ...
    def __init__(self, feature_name, classifier, class_names,
                 bow=True,
    ...
    def explain_dataset(self, sentences, labels, num_features=10, num_samples=1000):
        ...
        for unique_label in tqdm(self.class_names):
            ...
            instance_expls = [{k:v for (k,v) in self.explainer.explain_instance(sentence, self.predict, num_features=num_features, num_samples=num_samples).as_list()} for sentence in class_sentences]
    ...
    def set_feature_map(self, feature_name, embedding_kwargs=None, custom_feature_map=None):
        ...
        if feature_name == 'usages':
            ...
            model = DocumentEmbedding(dm=dm, embedding_dim=embedding_dim,
